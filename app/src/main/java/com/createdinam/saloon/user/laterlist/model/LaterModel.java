...
public class LaterModel {
    String salon_id,salon_unique_id,salon_name,image,discount,rating,address,latitude,longitude,availability,distance,featured_flag;
    ...
    public String getSalon_unique_id() {
        return salon_unique_id;
    }

    public void setSalon_unique_id(String salon_unique_id) {
        this.salon_unique_id = salon_unique_id;
    }
